...
- X-Token-Id: 'jeton' qui permet de savoir si le client a été authentifié
...
`curl -vH "x-student:EVERARD" https://webhook.site/d4ec90aa-8173-48dd-8414-6fb832ea2a26 -d "Hello World"`
...
`curl -vH "x-student:EVERARD" -H "Content-Type: application/json" https://webhook.site/d4ec90aa-8173-48dd-8414-6fb832ea2a26 -d "{'msg': 'Hello World'}"`
...
`curl -v -u apiuser:apipwd https://webhook.site/d4ec90aa-8173-48dd-8414-6fb832ea2a26`
...
* Transfer-Encoding: chunked
* Vary: Accept-Encoding
* X-Request-Id: 54a3e8fe-87fe-4f09-820c-5bcf3d04c424
* X-Token-Id: d4ec90aa-8173-48dd-8414-6fb832ea2a26
* Cache-Control: no-cache, private
* Date: Thu, 22 Sep 2022 18:01:49 GMT
* 

`curl -H "Authorization: Basic YXBpdXNlcjphcGlwd2Q=" https://webhook.site/d4ec90aa-8173-48dd-8414-6fb832ea2a26`
...
* Transfer-Encoding: chunked
* Vary: Accept-Encoding
* X-Request-Id: 367e9f03-b4cf-407b-935d-eb789266335d
* X-Token-Id: d4ec90aa-8173-48dd-8414-6fb832ea2a26
* Cache-Control: no-cache, private
* Date: Thu, 22 Sep 2022 18:07:36 GMT
* 
...
Pour éviter cette réponse nous pouvons utiliser l'option -L de curl qui permet de suivre les redirections `curl -L https://google.fr`, en utilisant avec le mode verbose nous pouvons voir que lorsque curl a reçu le code 301 il a suivit le lien indiqué dans l'en-tête de la réponse de la clé 'location'.
