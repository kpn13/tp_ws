...
curl -v -H "Authorization: Basic bG9naW4gOiBwYXNzd29yZA==" https:
//webhook.site/6f594809-a4b4-483e-841b-0c3b0a00edfe
...
< Transfer-Encoding: chunked
< Vary: Accept-Encoding
< X-Request-Id: ec8ee44c-c21d-4e42-a7b1-1302d1d3281a
< X-Token-Id: 6f594809-a4b4-483e-841b-0c3b0a00edfe
< Cache-Control: no-cache, private
< Date: Tue, 04 Oct 2022 15:21:29 GMT
<
* Connection #0 to host webhook.site left intact
...
status: 404 Not Found -> la page n'est pas trouvée.
...
## Quel est le code HTTP reçu ? Pouvez-vous expliquer cette réponse ?
 HTTP/2 301 -> redirection d'URL

## Comment éviter cette réponse ? Trouvez 2 solutions différentes et détaillez les.
curl -v https://google.fr -L

Il suffit de rajouter un -L pour permettre à Curl de suivre les redirections.

La deuxième solution serait de mettre l'adresse https final ce qui permettrait d'éviter les redirections.
